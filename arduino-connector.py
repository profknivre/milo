...
connection = '/dev/serial/by-path/platform-xhci-hcd.1-usb-0:1:1.0-port0' 	#this is the port your Arduino is connected to. You can check with ""sudo dmesg | grep tty"" in Terminal


# Set how many Inputs you have programmed in Arduino and which pins are Inputs, Set Inputs = 0 to disable
Inputs = 7 
InPinmap = [4,5,6,7,8,9,10] #Which Pins are Inputs?
